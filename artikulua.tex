...
\subsection{Young/Adult Identifier}\label{sec:identifier_background}
...
\section{Young/Adult Classifier}\label{sec:identifier}

This section describes the work performed in order to classify if a given tweet in Basque has been written by a young or adult user.
...
%\subsection{Erlazionatutako lanak}\label{sec:erl lan}

\indent Sare sozialen arloan ezaugarri demografikoak zeintzuk diren iragartzea, \textit{Social Media Mining} arloan gai ikertuetako bat da. Era honetan, sare sozialetako erabiltzaileen ezaugarriak antzemateko hainbat sistema garatu dira, adina edota sexua izanik ohikoenak \citep{cesare2017detection}. Kasu zehatz honetan, Twitterreko erabiltzaile euskaldunen bizitza etapa identifikatzea izango da asmoa, erabiltzaile hauek gazte edo helduen artean ezberdinduz. Gazte/heldu identifikatzaile honekin, bi bizitza etapen arteko konparaketa egitea izango da intentzioa, gai eta harremanetan ezberdintasunak antzemateko.\\

\indent Twitterren adinaren detekziorako
...
%\subsubsection{Corpusaren etiketatzea}\label{sec:corp etik}
...
%\subsubsection{Perplexity}\label{sec:ebal est}
